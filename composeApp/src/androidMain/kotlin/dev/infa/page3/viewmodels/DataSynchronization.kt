...
class DataSynchronization(
    ...
    /**
     * Sync sleep data by trying the new protocol first, then fallbacks
     */
    fun syncSleepData(deviceAddress: String, dayOffset: Int) {
        if (commandHandle == null) { addLog("ERROR: CommandHandle not initialized"); return }
        addLog("Syncing sleep data for day offset: $dayOffset")
