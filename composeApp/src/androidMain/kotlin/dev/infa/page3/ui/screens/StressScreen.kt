...
fun StressScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            // Live Stress Display (from device)
            item {
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Text(
                                text = when {
                                    ...
                                    instantStress != null && instantStress!! > 0 -> "Latest Measurement"
                                    currentStress > 0 -> "Live"
                                    else -> "Current"
                                },
                                style = MaterialTheme.typography.labelMedium,
                                color = when {
                                    isMeasuring -> Color(0xFFFF9800)
                                    currentStress > 0 -> Color(0xFF4CAF50)
                        ...
                        when {
                            ...
                            instantStress != null && instantStress!! > 0 -> {
                                Row(
                                    verticalAlignment = Alignment.CenterVertically
                                ) {
                                    Icon(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            if (instantStress != null && instantStress!! > 0) {
                        ...
                        Button(
                            ...
                            colors = ButtonDefaults.buttonColors(
                                containerColor = if (isMeasuring)
                                    Color(0xFFFF5722) else Color(0xFFE91E63)
                            ),
                            shape = RoundedCornerShape(12.dp)
                        ) {
                            Icon(
                                imageVector = if (isMeasuring)
                                    Icons.Default.Close else Icons.Default.Psychology,
                                contentDescription = null,
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Canvas(
                                ...
                                if (intervalReadings.size >= 2) {
                                    val maxValue = intervalReadings.maxOf { it.level }.coerceAtLeast(1)
                                    val minValue = intervalReadings.minOf { it.level }
                                    ...
                                    intervalReadings.forEachIndexed { index, reading ->
                                        val x = index * stepX
                                        val normalized = (reading.level - minValue).toFloat() / range.toFloat()
