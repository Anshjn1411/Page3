...
fun StepsScreen(
    onBack: () -> Unit,
    viewModel: StepAnalyticsViewModel
) {
    ...
    LaunchedEffect(dayOffset) {
        if (dayOffset > 0) {
            viewModel.fetchStepsByOffset(dayOffset)
        } else {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            DateSelector(
                ...
                onDateChange = { newDate ->
                    ...
                    val selected = Calendar.getInstance().apply { time = newDate }
                    dayOffset = ((today.timeInMillis - selected.timeInMillis) / (1000 * 60 * 60 * 24)).toInt()
                }
            )
            ...
            Column(
                ...
                // Main Steps Display
                MainStepsCard(steps = todaySteps)
    ...
    Card(
        ...
        Column(
            ...
            Row(
                ...
                Text("5,000", color = Color.Gray, fontSize = 12.sp)
                Text("10,000", color = Color.Gray, fontSize = 12.sp)
            }
            ...
            Row(
                ...
                QuickStatItem(
                    ...
                    value = "${(steps * 0.00078).format(1)} km",
                    label = "Distance",
    ...
    Row(
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text = String.format("%,d", avgStepsPerHour),
                    color = Color.White,
                    fontSize = 20.sp,
                    fontWeight = FontWeight.Bold
                )
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    text = String.format("%,d", bestDay?.totalSteps ?: 15680),
                    color = Color.White,
                    fontSize = 30.sp,
                    fontWeight = FontWeight.Bold
                )
